...
public class rough_sketch_transfer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					rough_sketch_transfer frame = new rough_sketch_transfer();
	...
	public rough_sketch_transfer() {
		...
		label_1.setBounds(12, 297, 207, 35);
		panel.add(label_1);
		...
		JLabel lblLogIn = new JLabel("Transfer");
		...
		txtrANewUser.setText("Transfering money is like signing a pay check, you own the process, you can do it anywhere, and it is powerful yet very validated. The only difference is that we do that really fast and on a whim.");
		...
		txtrTransferToAnother.setBounds(23, 0, 134, 42);
		txtrTransferToAnother.setText("    Transfer to your another card");
		...
		panel_5.setBounds(12, 13, 487, 419);
		...
		txtAmountOfMoney.setBounds(12, 99, 463, 35);
		...
		txtDateOfTranaction.setBounds(12, 147, 463, 35);
		...
		txtPinCode.setBounds(12, 250, 463, 35);
		...
		lblConfirm_1.setBounds(268, 195, 207, 42);
		...
		lblConfirm.setBounds(268, 298, 207, 42);
		...
		txtrYouWillReceive.setBounds(12, 298, 244, 78);
		panel_5.add(txtrYouWillReceive);
		
		JPanel panel_6 = new JPanel();
		panel_6.setOpaque(false);
		panel_6.setBounds(511, 13, 157, 419);
		transfercard.add(panel_6);
		panel_6.setLayout(null);
		
		JLabel lblYourCards = new JLabel("Your Cards");
		lblYourCards.setHorizontalAlignment(SwingConstants.CENTER);
		lblYourCards.setForeground(Color.BLACK);
		lblYourCards.setFont(new Font("Square721 BT", Font.PLAIN, 20));
		lblYourCards.setBounds(12, 13, 133, 25);
		panel_6.add(lblYourCards);
		
		JPanel panel_7 = new JPanel();
		panel_7.setBounds(12, 51, 133, 78);
		panel_6.add(panel_7);
		
		JPanel panel_8 = new JPanel();
		panel_8.setBounds(12, 142, 133, 78);
		panel_6.add(panel_8);
		...
		JTextArea txtrTransferToFriends = new JTextArea();
		txtrTransferToFriends.setWrapStyleWord(true);
		txtrTransferToFriends.setText("    Transfer to     friend's card");
		txtrTransferToFriends.setOpaque(false);
		txtrTransferToFriends.setLineWrap(true);
		txtrTransferToFriends.setFont(new Font("Square721 BT", Font.PLAIN, 15));
		txtrTransferToFriends.setEnabled(false);
		txtrTransferToFriends.setDisabledTextColor(Color.BLACK);
		txtrTransferToFriends.setComponentOrientation(ComponentOrientation.LEFT_TO_RIGHT);
		txtrTransferToFriends.setBounds(23, 0, 110, 42);
		panel_4.add(txtrTransferToFriends);
	}
}
